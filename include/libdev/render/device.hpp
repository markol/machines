...
#ifndef _RENDER_DEVICE_HPP
#define _RENDER_DEVICE_HPP
...
public:
	...
	bool fitToDisplay(RenDisplay* pDisplay);
    ...
    friend ostream& operator <<( ostream& o, const RenDevice& t );
	...
	void renderSurface(const RenISurfBody* surf, const Ren::Rect& srcArea, const Ren::Rect& dstArea, const uint targetW = 0, const uint targetH = 0, const uint colour = 0xFFFFFFFF);
    ...
    void renderToTextureMode(const GLuint targetTexture, uint viewPortW, uint viewPortH);
...
private:
	...
	RenIDeviceImpl* pImpl_;

	GLuint glProgramID_GIU2D_, glProgramID_Standard_, glProgramID_Billboard_;

	GLuint gl2DVertexBufferID_, glVertexUVID_, glVertexPosition_screenspaceID_, glVertexColour_screenspaceID_, glScreenspaceID_;

	GLuint gl2DUniformID_, glTextureSamplerID_, glTextureSamplerBillboardID_;
	GLuint glModelMatrixID_, glViewMatrixID_, glProjectionMatrixID_;
