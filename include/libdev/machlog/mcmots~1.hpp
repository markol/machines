...
private:
    ...
    (
        ...
        const MachPhysMachineMoveInfo& info, const PhysAbsoluteTime& collideTime,
        MexPoint2d* pNewPoint
    );
    ...
    typedef auto_ptr< MachPhysMachineMoveInfo > MoveInfoAPtr;
    ...
    // Try for a simple straight line move directly to our destination. If we 
    // can do it, start the move immediately.
    bool straightLineMove( PhysRelativeTime* pInterval );
