...
//	CTL_PAIR( pairTest, int, key, MexTransform3d, transform );
    ...
    ctl_map< pairTest, int, std::less< pairTest > >  map1;
    ...
    std::less< tripleTest >  lt1;

    ctl_map< tripleTest, int, std::less< tripleTest > >  map2;
    ...
    std::less< quadTest >  lq1;

    ctl_map< quadTest, int, std::less< quadTest > >  map3;
}
