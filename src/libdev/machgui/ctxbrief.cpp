...
void MachGuiCtxBriefing::displayBriefingImage( void )
{
	if ( pBriefImage_ )
	{
...
void MachGuiCtxBriefing::playBriefingVoicemail( void )
{
	stopPlayingBriefingVoicemail();
...
void MachGuiCtxBriefing::stopPlayingBriefingVoicemail( void )
{
