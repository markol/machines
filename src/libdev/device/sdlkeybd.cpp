...
const ushort DevSdlKeyboard::scanCodeToKeyNumMap[SDL_NUM_SCANCODES] = {
        ...
        0x0, 	//	// 2 (unused)
        0x0, 	//	// 3 (unused)
        30, //	SDL_SCANCODE_A = 4, - DIK_A
        48,	//	SDL_SCANCODE_B = 5, - DIK_B
        46,	//	SDL_SCANCODE_C = 6, - DIK_C
        32,	//	SDL_SCANCODE_D = 7, - DIK_D
        18,	//	SDL_SCANCODE_E = 8, - DIK_E
        33,	//	SDL_SCANCODE_F = 9, - DIK_F
        34,	//	SDL_SCANCODE_G = 10, - DIK_G
        35,	//	SDL_SCANCODE_H = 11, - DIK_H
        23,	//	SDL_SCANCODE_I = 12, - DIK_I
        36,	//	SDL_SCANCODE_J = 13, - DIK_J
        37,	//	SDL_SCANCODE_K = 14, - DIK_K
        38,	//	SDL_SCANCODE_L = 15, - DIK_L
        50,	//	SDL_SCANCODE_M = 16, - DIK_M
        49,	//	SDL_SCANCODE_N = 17, - DIK_N
        24,	//	SDL_SCANCODE_O = 18, - DIK_O
        25,	//	SDL_SCANCODE_P = 19, - DIK_P
        16,	//	SDL_SCANCODE_Q = 20, - DIK_Q
        19,	//	SDL_SCANCODE_R = 21, - DIK_R
        31,	//	SDL_SCANCODE_S = 22, - DIK_S
        20,	//	SDL_SCANCODE_T = 23, - DIK_T
        22,	//	SDL_SCANCODE_U = 24, - DIK_U
        47,	//	SDL_SCANCODE_V = 25, - DIK_V
        17,	//	SDL_SCANCODE_W = 26, - DIK_W
        45,	//	SDL_SCANCODE_X = 27, - DIK_X
        21,	//	SDL_SCANCODE_Y = 28, - DIK_Y
        44,	//	SDL_SCANCODE_Z = 29, - DIK_Z
        ...
        69,	//	SDL_SCANCODE_PAUSE = 72, - DIK_PAUSE 0xC5,remapped to break
